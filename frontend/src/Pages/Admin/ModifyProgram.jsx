        ...
        <div className="col-lg-9 col-12 i-moprg-div2">
          ...
          <div className="row mt-4 align-items-center">
            ...
            <div className="col-md-6">
              <input type="text" className="i-moprg-form-control form-control" />
            </div>
          </div>
          ...
          <div className="row mt-4">
            <div className="col-9">
              <div className="i-moprg-cuadrado">
          ...
          <div className="row mt-4 align-items-center">
            ...
            <div className="col-md-6">
              <textarea className="i-moprg-form-control form-control" rows="6" placeholder=""></textarea>
            </div>
          </div>
          ...
          <div className="row mt-4">
            ...
            <div className="col-md-2">
              <button className="btn i-moprg-modify-program-button w-100">Modificar</button>
            </div>
          </div>
        </div>
      </div>
