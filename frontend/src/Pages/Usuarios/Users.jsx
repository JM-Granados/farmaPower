                ...
                <div className="col-lg-9 col-12 j-maem-div2">
                    <div className="row j-maem-div3 align-items-end">
                        <div className="col-12 div-gradient-header">
                            <img className='j-maem-imagen' src={Usuarios} alt="Usuarios" />
                        </div>
                    </div>
                    ...
                    <div className="row mt-3">
                        ...
                        <div className="col-md-4 d-flex align-items-center">
                            <span className='j-maem-no-coincidences'>No hay coincidencias?</span>
                            <a href="/Registrar_User" className="j-maem-gradient-link mx-2">Registrar nuevo</a>
                        </div>
                    </div>
                                        ...
                                        <div className="card-body text-white rounded-2">
                                            <p className="card-text">
                                                <div className="edit-icon" onClick={() => handleEditClick(user)}>
                                                    <img src={EDITAR} alt="Edit" className="edit-icon" />
                                                </div>
