            ...
            <div className="hcontainer container justify-content-start">
                <ul className="barrita nav nav-underline">
                    <li className="barrota nav-item">
                        <a className="barritita nav-link active text-white" aria-current="page" href="/Home_Client">Inicio</a>
                    </li>
                    <li className="barrota nav-item">
                        <a className="barritita nav-link text-white" href="/MyRequests">Mis solicitudes</a>
                    </li>
                    <li className="barrota nav-item">
                        <a className="barritita nav-link text-white" href="/Medications">Medicamentos participantes</a>
                    </li>
                    <li className="barrota nav-item">
                        <a className="barritita nav-link text-white" href="/Pharmacies">Farmacias participantes</a>
                    </li>
                    <li className="barrota nav-item">
                        <a className="barritita nav-link text-white" href="/Programs">Programas</a>
                    </li>
                </ul>
            </div>

            <div className="contiene container-fluid d-flex justify-content-center">
                <Link to="/NewRequest" className="ir ms-5 mt-5 me-5 card-link">
                    <div className="card">
                        <img src={nuevaSolicitud} className="card-img-top" alt="..." />
                    </div>
                </Link>

                <Link to="/registerProgram" className="ir ms-5 mt-5 me-5 card-link">
                    <div className="card">
                        <img src={OfertaNueva} className="card-img-top" alt="..." />
                    </div>
                </Link>

                <Link to="/Help" className="ir ms-5 mt-5 me-5 card-link">
                    <div className="card">
